...
echo "Running Flang"
flang-new -fc1 -J /home/nick/projects/xdsl/dl_timer -emit-hlfir -mmlir -mlir-print-op-generic -fopenmp  $1
...
ftn-opt $filename_no_ext"_isol.mlir" -p convert-to-tt -o $filename_no_ext"_tt.mlir"
